...
function Leyes() {
  return (
    ...
    <div className='leyes-text'>
      ...
      <span>Publicado el 1 de agosto de 2014</span>
      <p>Ley 4095</p>
      <span>Publicado en la Edición: </span><span>58NEC </span><span>Fecha de Publicación: </span><span>02/09/2009</span>
      <p>21 DE AGOSTO DE 2009.- Declara de necesidad y utilidad pública, la construcción de albergues para animales domésticos abandonados en la ciudad de Oruro, a fin de proteger la salud e integridad física de las personas así como el bienestar de los animales.</p>
      <p>Ley 4040</p>
      <span>Publicado en la Edición: </span><span>39NEC </span><span>Fecha de Publicación: </span><span>01/07/2009</span>
      <p>17 DE JUNIO DE 2009.- Elimina el uso de animales silvestres y/o domésticos en espectáculos circenses en todo el territorio nacional, por considerarse la práctica un acto de crueldad en contra de los animales.</p>
      <div>
        <p>Ley 1333</p>
        <span>Fecha de Publicación: </span><span>27/04/1992</span>
        <span>Artículo 111. </span>
